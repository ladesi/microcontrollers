...
# 44 "./main.h"
unsigned char disp1_val = 0;
unsigned char disp2_val = 0;
unsigned char disp3_val = 0;
unsigned char disp4_val = 0;
...
void main(void)
{
    ...
    while(1)
    {
        ...
        PORTC = tab1[disp1_val];
        PORTBbits.RB2 = 1;
        _delay((unsigned long)((50)*(20000000/4000.0)));
        PORTBbits.RB2 = 0;
        PORTC = tab1[disp2_val];
        PORTBbits.RB3 = 1;
        _delay((unsigned long)((50)*(20000000/4000.0)));
        PORTBbits.RB3 = 0;
        PORTC = tab1[disp3_val];
        PORTBbits.RB4 = 1;
        _delay((unsigned long)((50)*(20000000/4000.0)));
        PORTBbits.RB4 = 0;
        PORTC = tab1[disp4_val];
        PORTBbits.RB5 = 1;
        _delay((unsigned long)((50)*(20000000/4000.0)));
        PORTBbits.RB5 = 0;
    }
