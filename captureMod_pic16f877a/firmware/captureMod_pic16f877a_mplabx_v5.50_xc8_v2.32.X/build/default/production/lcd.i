...
volatile unsigned int tmr1_counter1;
volatile unsigned int tmr1_counter2;
unsigned char number_of_edges;
unsigned char two_edges_flag;
unsigned char pulses_char_val[10];
# 9 "lcd.c" 2
...
unsigned char var7;
# 57 "lcd.c"
void lcd_delay_1us(void) {_delay((unsigned long)((1)*(20000000/4000000.0)));}
void lcd_delay_40us(void) {_delay((unsigned long)((40)*(20000000/4000000.0)));}
void lcd_delay_2ms(void) {_delay((unsigned long)((2)*(20000000/4000.0)));}
void lcd_delay_40ms(void) {_delay((unsigned long)((40)*(20000000/4000.0)));}
