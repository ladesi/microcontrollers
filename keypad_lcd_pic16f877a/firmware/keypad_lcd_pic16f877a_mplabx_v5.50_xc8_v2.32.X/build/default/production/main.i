...
{
    PORTCbits.RC4 = 1; PORTCbits.RC5 = 0; PORTCbits.RC6 = 0;
    if (PORTCbits.RC0 == 1) return '1';
    else if (PORTCbits.RC1 == 1) return '4';
    else if (PORTCbits.RC2 == 1) return '7';
    else if (PORTCbits.RC3 == 1) return '*';

    PORTCbits.RC4 = 0; PORTCbits.RC5 = 1; PORTCbits.RC6 = 0;
    if (PORTCbits.RC0 == 1) return '2';
    else if (PORTCbits.RC1 == 1) return '5';
    else if (PORTCbits.RC2 == 1) return '8';
    else if (PORTCbits.RC3 == 1) return '0';

    PORTCbits.RC4 = 0; PORTCbits.RC5 = 0; PORTCbits.RC6 = 1;
    if (PORTCbits.RC0 == 1) return '3';
    else if (PORTCbits.RC1 == 1) return '6';
    else if (PORTCbits.RC2 == 1) return '9';
    else if (PORTCbits.RC3 == 1) return '#';
