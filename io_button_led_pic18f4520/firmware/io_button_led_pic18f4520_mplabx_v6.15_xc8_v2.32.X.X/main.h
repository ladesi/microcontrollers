...
// CONFIG1H
#pragma config OSC = HS      // Oscillator Selection bits (External RC oscillator, port function on RA6)
...
#define bot1 !PORTDbits.RD0     // button at RD0 pin
#define led1 PORTDbits.RD1      // led at RD1 pin
